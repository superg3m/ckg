...
void ckg_str_check_magic(CKG_String str) {
    ckg_assert(str && ckg_str_equal(ckg_str_header(str)->magic, STR_MAGIC), "String: %s contains the wrong magic: (%s) Likely not a CKG_String\n", str, ckg_str_header(str)->magic);
}
...
CKG_String MACRO_ckg_str_append(CKG_String string, const char* to_append) {
    assert_in_function(string, "ckg_str_append: String passed is null\n");
    assert_in_function(to_append, "ckg_str_append: Source passed is null\n");
...
CKG_String MACRO_ckg_str_append_char(CKG_String string, const char to_append) {
    assert_in_function(string, "ckg_str_append_char: String passed is null\n");
    assert_in_function(to_append, "ckg_str_append_char: Source passed is null\n");
